            ...
            <section>
              ...
              {service.transferRoutes?.length ? (
                <div className="space-y-6 rounded-3xl border border-ink/20 bg-paper-warm p-6">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <label className="space-y-2">
                      ...
                      <select
                        ...
                        className="w-full rounded-2xl border border-[rgba(150,112,31,0.4)] bg-white px-4 py-3 text-ink-soft outline-none"
                      >
                  ...
                  <div className="rounded-3xl border border-[rgba(150,112,31,0.4)] bg-white p-5 shadow-oil-sm">
                    ...
                    {selectedRoute && (
                      <div className="mt-3 grid gap-2 text-sm text-ink-soft">
                        ...
                        <div className="mt-3 rounded-lg border border-ink/15 bg-paper-warm p-3">
