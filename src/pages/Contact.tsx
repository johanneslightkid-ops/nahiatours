      ...
      <div className="section-shell -mt-6">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
          ...
          <div className="glass-card rounded-[28px] p-8">
            <h2 className="mb-5 font-display text-3xl font-semibold text-ink"><FormattedMessage id="contact.getInTouch" /></h2>
            ...
            <iframe
              ...
              width="100%"
              height="280"
              className="mt-6 rounded-[18px] border border-ink/15"
              loading="lazy"
