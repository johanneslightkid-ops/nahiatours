...
const Transport: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="grid min-h-screen place-items-center font-display text-xl font-semibold text-ink">
        Loading…
      </div>
    );
  }
        ...
        {!config ? (
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:gap-8">
            <div className="flex-1 space-y-5 md:space-y-6">
              <div className="rounded-2xl border border-ink/15 bg-white p-4 shadow-ink-sm md:p-6">
              ...
              <div className="rounded-2xl border border-ink/15 bg-white p-4 shadow-ink-sm md:p-6">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className={`flex-1 rounded-2xl border border-ink/15 px-4 py-4 text-center text-base font-semibold shadow-ink-sm transition ${
                      tripType === 'round-trip'
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full appearance-none rounded-2xl border border-ink/15 bg-white px-4 py-4 text-base focus:bg-lagoon-light focus:outline-none"
                    >
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <label className="flex items-center gap-3 rounded-xl border border-ink/20 p-4 transition has-[:checked]:border-ink has-[:checked]:bg-lagoon-light active:scale-[0.98]">
                    <input
                      ...
                      className="h-5 w-5 rounded border border-ink/15 text-lagoon-dark"
                    />
            ...
            <div className="w-full lg:w-80 xl:w-96">
              <div className="sticky top-24 space-y-5 md:space-y-6">
                <div className="rounded-2xl border border-ink/15 bg-white p-5 shadow-ink-sm md:p-6">
                  <h2 className="mb-4 text-lg font-semibold text-ink-soft">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full rounded-2xl border border-ink/15 bg-white px-6 py-4 text-center text-base font-semibold text-lagoon-dark transition hover:bg-lagoon-light active:scale-[0.97]"
                  >
