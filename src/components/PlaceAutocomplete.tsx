    ...
    <div className="relative">
      <div className="relative flex items-center gap-2">
        <input
          ...
          className="w-full rounded-2xl border border-[rgba(150,112,31,0.4)] bg-white px-4 py-4 text-base focus:bg-lagoon-light focus:outline-none"
        />
        {inputValue && (
          <button
            type="button"
      ...
      {showSuggestions && suggestions.length > 0 && (
        <ul className="absolute z-20 mt-1 w-full overflow-hidden rounded-2xl border border-[rgba(150,112,31,0.4)] bg-white shadow-oil-sm">
          {suggestions.map((s) => (
            <li
              key={s.placeId}
