    ...
    >
      <div className="grid md:grid-cols-[15rem_1fr] lg:grid-cols-[18rem_1fr]">
        ...
        <div className="relative h-48 overflow-hidden md:h-full">
          ...
          <span
            className={`absolute left-4 top-4 inline-flex items-center gap-1.5 rounded-full border border-ink/15 px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.14em] text-ink ${
          ...
          {item.pinned && (
            <span className="absolute right-4 top-4 inline-flex items-center gap-1 rounded-full border border-ink/15 bg-paper px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.14em] text-ink">
