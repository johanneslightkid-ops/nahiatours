              ...
              <div className="mb-6 flex items-center gap-3">
                <div className="grid h-14 w-14 shrink-0 place-items-center overflow-hidden rounded-full bg-white/95 shadow-lg">
                  {brandSettings.brandicon ? (
                    <img src={brandSettings.brandicon} alt="Logo" loading="lazy" decoding="async" className="h-full w-full object-cover" />
                  ) : (
                    <img src="/competitor-logo.svg" alt="Logo" loading="lazy" decoding="async" className="h-10 w-10" />
                  )}
                </div>
