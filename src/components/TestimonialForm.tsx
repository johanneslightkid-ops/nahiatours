...
const TestimonialForm: React.FC<TestimonialFormProps> = ({ onSubmit, isLoading = false }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-6 rounded-[26px] border border-[rgba(150,112,31,0.4)] bg-paper shadow-oil">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className="w-full py-3 px-4 rounded-full border border-[rgba(150,112,31,0.4)] bg-mango font-extrabold uppercase tracking-wide text-ink shadow-oil-sm transition hover:-translate-y-0.5 hover:bg-mango-light disabled:cursor-not-allowed disabled:opacity-50"
        >
