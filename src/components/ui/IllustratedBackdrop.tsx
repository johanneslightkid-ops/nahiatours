...
const IllustratedBackdrop: React.FC = () => (
  ...
  >
    ...
    <div
      ...
      style={{
        background:
          'linear-gradient(178deg, #F5F1E8 0%, #EDE4D3 42%, #E3D7C0 78%, #CEBDA0 100%)',
      }}
    />
    ...
    <div
      ...
      style={{
        background: 'linear-gradient(96deg, #14100E 0%, #14100E 62%, #C1121F 100%)',
    ...
    <div
      ...
      style={{
        backgroundImage:
          'repeating-linear-gradient(45deg, #14100E 0 10px, transparent 10px 20px)',
      }}
    />
