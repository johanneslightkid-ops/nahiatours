  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div
        ...
        className="relative w-full cursor-pointer rounded-2xl border border-[rgba(150,112,31,0.4)] bg-white px-4 py-4 text-base transition focus-within:bg-lagoon-light"
      >
        ...
        <div className="fixed inset-0 z-50 flex items-end bg-black/40 md:items-center md:justify-center" onClick={() => setIsOpen(false)}>
          <div className="w-full rounded-t-3xl bg-white px-6 py-8 md:max-w-sm md:rounded-3xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mb-8 flex items-center justify-center gap-6">
              <button
                onClick={decrement}
                className="flex h-24 w-24 items-center justify-center rounded-2xl border border-[rgba(150,112,31,0.4)] bg-paper text-4xl font-extrabold text-ink shadow-oil-sm transition hover:bg-mango-light active:translate-y-0.5"
